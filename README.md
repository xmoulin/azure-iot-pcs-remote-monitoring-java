...
> The remote monitoring solution incorporates learnings from customers and partners,
> and is a fully operational IoT solution right out of the box. 
>
...
> [Issues List](https://github.com/Azure/azure-iot-pcs-remote-monitoring-java/blob/master/issues)
> in this repo (and in any submodules) to see known requests and issues. 
>
> There is also a .NET version of this repo available [here](https://github.com/Azure/azure-iot-pcs-remote-monitoring-dotnet)
...
[issues](https://github.com/Azure/azure-iot-pcs-remote-monitoring-java/issues). 
We also love PRs for fixes too!

We have a [User Voice](https://feedback.azure.com/forums/321918-azure-iot)
channel for your suggestions on features and future supported scenarios.
We encourage you to browse what others are suggesting, vote for your favorites,
and enter suggestions of your own.
